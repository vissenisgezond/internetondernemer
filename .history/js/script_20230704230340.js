$(document).ready(function() {
    ...
    $('#icon-projecten2').on('click', function() {
        ...
        $('.resume-page').fadeIn(1200); // Ensure that the 'projecten-page' class is applied to the div you want to display
    });
   ...
   // code under this is for buttons on the about page 
